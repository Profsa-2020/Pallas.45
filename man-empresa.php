...
<head>
     ...
     <title>Empresa - Análise de Investimentos - Profsa Informátda Ltda</title>
</head>
...
<?php
     ...
     if (isset($_SERVER['HTTP_REFERER']) == true) {
          if (limpa_pro($_SESSION['wrknompro']) != limpa_pro($_SERVER['HTTP_REFERER'])) {
               ...
               $ret = gravar_log(6, "Entrada na página de manutenção de empresa Pallas.45 - MoneyWay");  
          }
     }
     if (isset($_SESSION['wrkopereg']) == false) { $_SESSION['wrkopereg'] = 0; }
     if (isset($_SESSION['wrkcodreg']) == false) { $_SESSION['wrkcodreg'] = 0; }
     if (isset($_SESSION['wrknumvol']) == false) { $_SESSION['wrknumvol'] = 0; }
    ...
    if (isset($_REQUEST['salvar']) == true) {
        ...
        if ($_SESSION['wrkopereg'] == 1) {
            ...
            if ($ret == 0) {
                $ret = incluir_emp();
                $ret = gravar_log(11,"Inclusão de nova empresa: " . $des);
                $cgc = ''; $des = ''; $fan = ''; $ema = ''; $sta = 00; $tel = ''; $cel = ''; $cep = ''; $end = ''; $num = ''; $com = ''; $bai = ''; $cid = ''; $est = ''; $ins = ''; $sit = ''; $con = ''; 
                echo '<script>history.go(-' . $_SESSION['wrknumvol'] . ');</script>';
                $_SESSION['wrknumvol'] = 1;
            }
        }
        if ($_SESSION['wrkopereg'] == 2) {
            ...
            if ($ret == 0) {
                $ret = alterar_emp();
                $ret = gravar_log(12,"Alteração de empresa existente: " . $des);
                $cgc = ''; $des = ''; $fan = ''; $ema = ''; $sta = 00; $tel = ''; $cel = ''; $cep = ''; $end = ''; $num = ''; $com = ''; $bai = ''; $cid = ''; $est = ''; $ins = ''; $sit = ''; $con = ''; 
                echo '<script>history.go(-' . $_SESSION['wrknumvol'] . ');</script>';
                $_SESSION['wrknumvol'] = 1;
            }
                    ...
                    <form class="tel-1" name="frmTelMan" action="" method="POST">
                         <div class="row">
                              ...
                              <div class="col-md-3">
                                   ...
                                   <input type="text" class="form-control text-center" maxlength="15" id="ins"
                                        name="ins" value="<?php echo $ins; ?>" />
                              </div>
                         </div>
                         <div class="row">
                              <div class="col-md-7">
