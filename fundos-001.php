...
<?php 
     ...
     $nor = (isset($_REQUEST['nor']) == false ? 1 : $_REQUEST['nor']);
                    ...
                    <form class="qua-6" id="frmTelCon" name="frmTelCon" action="con-fundos.php" method="POST">
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-2"><br />
                                   ...
                                   <input type="checkbox" id="exc" name="exc" value="1"
                                        <?php echo ($exc == 0 ? '' : 'checked' ) ?> />
                                   <br />
                                   <span>Funcionamento Normal</span> &nbsp;
                                   <input type="checkbox" id="nor" name="nor" value="1"
                                        <?php echo ($nor == 0 ? '' : 'checked' ) ?> />
                              </div>
                              <div class="col-md-2"><br />
                         ...
                         <div class="col-md-12">
                              ...
                              <div class="tab-1 table-responsive">
                                   <table id="tab-0" class="table table-sm table-striped">
                                        ...
                                        <tbody>
                                             <?php $ret = carrega_fun($cla, $pub, $esp, $con, $tem, $pat, $anb, $nor, $exc, $cot, $atu);  ?>
                                        </tbody>
                                   </table>
                                   <hr />
                              </div>
...
<?php
function carrega_fun($cla, $pub, $esp, $con, $tem, $pat, $anb, $nor, $exc, $cot, $atu) {
     include_once "dados.php";
     include_once "profsa.php";
     $dti = date('01/01/2000');
     $dtf = date('d/m/Y');
     ...
     $com .= " and funexclusivo = " . ($exc == '0' ? '1' : '0'). "";  // Exclusivo
     $com .= " and funnormal = " . ($nor == '0' ? '0' : '1'). "";     // Normal
     $com .= " and funatuadiaria = '" . $atu . "'";                        // Cota Diária 
     $com .= " and funcotas = '" . ($cot == 'N' ? 'N' : 'S') . "'";    // Fundo Cotas  
     ...
     foreach ($reg as $lin) {
          ...
          if ($flag == 0) {
               ...
               $txt .= '<td class="text-center">' . ($lin['funnormal'] == 0 ? 'Não' : 'Sim') . '</td>';
               $cpo = "*** " . $lin['funclasse'] . ' ***';
