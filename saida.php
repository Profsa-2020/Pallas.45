...
<?php
    ...
    $ret = gravar_log(99, "Saída do sistema Plass.45 - MoneyWay Análise de Investimentos");  
...
<body>
     <h1 class="cab-0">Página de Saída Sistema MoneyWay Investimentos - Profsa Informática Ltda</h1>
     <div id="particles-js" class="sai-1 text-center">
                    ...
                    <div class="col-md-12">
                         <a href="index.php">
                              <img class="img-fluid" src="img/logo-01.png" class="img-responsive center-block"
                                   alt="Logotipo da empresa MoneyWay Investimentos"
                                   title="Acesso ao site principal da MoneyWay Investimentos - Análise de Investimentos" />
                         </a>
                    </div>
               </div>
          </div>
          ...
          <div class="saida animated fadeInUp text-center">
               <h2><strong>Obrigado por utilizar o sistema da MoneyWay Investimentos - Análise de Investimentos</strong></h2>
               <br />
