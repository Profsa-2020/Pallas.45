...
<head>
     ...
     <title>Resumo - Análise de Investimentos - MoneyWay</title>
</head>
...
<?php
     ...
     if (isset($_SERVER['HTTP_REFERER']) == true) {
          if (limpa_pro($_SESSION['wrknompro']) != limpa_pro($_SERVER['HTTP_REFERER'])) {
               ...
               $ret = gravar_log(11,"Entrada na página de resumo de análise de fundos do sistema Pallas.45 - MoneyWay");  
          }
     }
...
<body id="box00">
     <h1 class="cab-0">Resumo de Análise de Funcos - MoneyWay Investimentos - Profsa Informática</h1>
