...
<head>
     ...
     <title>Usuário - Análise de Investimentos - Profsa Informátda Ltda</title>
</head>
...
<?php
     ...
     if (isset($_SERVER['HTTP_REFERER']) == true) {
          if (limpa_pro($_SESSION['wrknompro']) != limpa_pro($_SERVER['HTTP_REFERER'])) {
               ...
               $ret = gravar_log(6,"Entrada na página de manutenção de usuários do sistema Pallas.45 - MoneyWay");  
          }
     }
     ...
     $emp = (isset($_REQUEST['loj']) == false ? 0 : $_REQUEST['loj']);
...
<body id="box00">
     <h1 class="cab-0">Usuário Principal - MoneyWay Investimentos - Profsa Informática</h1>
     ...
     <div class="container-fluid">
          <div class="row">
               ...
               <div class="col-md-10">
                    <!-- Corpo -->
                    <p class="lit-4">Manutenção de Usuários <a href="man-usuario.php?ope=1&cod=0" title="Abre janela para criação de novo usuário no sistema"><i class="fa fa-plus-circle fa-1g" aria-hidden="true"></i></a></p>
                    <form class="tel-1" name="frmTelMan" action="" method="POST">
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-8">
                                   ...
                                   <select id="loj" name="loj" class="form-control">
                         ...
                         <div class="row">
                              ...
                              <div class="col-3">
                                   ...
                                   <input type="text" class="form-control text-center" maxlength="15" id="cel"
                                        name="cel" value="<?php echo $cel; ?>" />
                              </div>
                              <div class="col-3">
                                   <label>Validade</label>
                                   <input type="text" class="form-control text-center" maxlength="10" id="val"
                                        name="val" value="<?php echo $val; ?>" />
                              </div>
                         </div>
                         <br />
                         <div class="row">
 ...
 function consiste_usu() {
     ...
     if ($_REQUEST['tip'] <= 3) {
          if ($_REQUEST['loj'] == '' || $_REQUEST['loj'] == '0') {
               echo '<script>alert("Código da loja do usuário não pode estar em branco, informe");</script>';
               return 5;
          }
     }
     include_once "dados.php";     
...
function alterar_usu() {
 ...
 function enviar_ema($ema_usu) {
     ...
     if ($nro == 1 || $reg == true) {
         ...
         $tex .= '<title>MoneyWay Análise de Investimentios</title>';
         $tex .= '</head>';
         $tex .= '<body>';
         $tex .= '<p align="center">';
         $tex .= '<img border="0" src="http://www.moneyway.com.br/pallas45/img/logo-01.png"></p>';
         ...
         $tex .= '<p align="center"><font size="4" face="Verdana"><a href="http://www.moneyway.com.br/pallas45/index.php">';
